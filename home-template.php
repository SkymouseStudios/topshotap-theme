...
<div id="primary">
	<main id="main" class="site-main" role="main">
		...
		<section class="panel-sales">
			<h2 class="center-text">Your one-stop drone team.</h2>
			<p class="center-text subheading">Video editing, location scouting, timelapses: they all get done while you focus on what you love. With all the solutions in one place, drone videos are easier than ever before.</p>
